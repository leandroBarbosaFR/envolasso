...
const StyledButton = styled(FilteredButtonLink)`
  // ==========================================================================
  // Global
  // ==========================================================================
  ...
  position: ${({ variant, theme }) => theme.button[variant!].position};
  /* Props style */
  ...
  /* Is Activated state  */
  color: ${({ isActive, variant, theme }) => isActive && theme.button[variant!].fontColorActive};
  svg {
    fill: ${({ isActive, variant, theme }) => isActive && theme.button[variant!].icon.fillActive};
  }
  ${({ isActive, variant, theme }) =>
    isActive &&
    css`
      color: ${isActive && theme.button[variant!].fontColorActivated};
      background: ${isActive && theme.button[variant!].backgroundaActivated};
      font-weight: ${isActive && theme.button[variant!].fontWeightActivated};
      box-shadow: ${theme.button[variant!].boxShadowActivated};
      svg {
        fill: ${isActive && theme.button[variant!].icon.fillActivated};
        transform: ${theme.button[variant!].transform};
      }
    `};
  // ==========================================================================
  // Mobile
