...
const NavArrows = ({ layoutVariant, slideToPrevItem, slideToNextItem, handleAutoSlide }: NavArrowsProps) => {
  ...
  return (
    <StyledNav layoutVariant={layoutVariant}>
      ...
      >
        <StyledNavGrid
          withRowGap={theme.Carousel[layoutVariant!].NavArrows.StyledNavGrid.withRowGap}
          withColGapp={theme.Carousel[layoutVariant!].NavArrows.StyledNavGrid.withColGapp}
          layoutVariant={layoutVariant}
        >
